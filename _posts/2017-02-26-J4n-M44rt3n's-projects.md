...
#
**Dremelfuge**<BR>
Someone on the internet built a dremeltool centrifuge add-on. Inspired by this, I built one too. Mine can be 3D printed in one go, moving parts and all, without the need for assembly or scaffolding. The trick for this is to use ball and socket joints between moving parts. I spun the add-on at the dremeltool's maximum speed (35.000 rpm), and it took it without problems. Still, if you make this yourself, be safe and use it in a bucket! The picture to the right opens a movieclip of the tool in action. 
